...
public class Pokemon {
    ...
    public void setIdade (int valor) {
        ...
        } else if (this.idade >= this.idadeMax){
            this.vivo = false;
    ...
    public void setLimpeza (int valor) {
        ...
        } else if (this.limpeza >= this.limpezaMax){
    ...
    void bricar (String brincadeira){
        if (brincadeira.equals("volei")){
            ...
            setLimpeza(-1);
            setIdade(1);
            System.out.println("Nossa, consegui o meu par perfeito <3");
...
public static void main(String[] args) {
    ...
    System.out.println("Digite brincar e o nome de um dos jogos abaixo para eu me divertir");
